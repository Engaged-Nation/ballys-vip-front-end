<?php require_once __DIR__ . '/../../ballys-vip-portal/vendor/engaged-nation/portal-core/FrontEnd/Bootstrap/client-front-end.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>VIP Preferred at Bally's Atlantic City</title>
    <?php require_once __DIR__ . '/../../ballys-vip-portal/vendor/engaged-nation/portal-core/GoogleTagManager/Resources/public/gtm.php'; ?>
...
<body>
    ...
    <script src="//<?php echo $enConfigClient['environment']['site_portal']; ?>/lib/js/engage.php?client_name=ballys-vip&client_id=25cbe78399a90bc83fa47a30af45c486" type="text/javascript"></script>
